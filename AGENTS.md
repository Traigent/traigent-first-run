...
revalidating a working copy; allow a labeled demonstration only when the component is technically
safe, and never optimize against a broken grading signal.

Do the technical work. Ask only at genuine choices, secret entry, paid/provider calls,
private-data egress, judgment-dependent gold/rubric changes, destructive changes, or
