...
| [`tests/`](tests/) | The guide's own quality gates — the offline no-network contract, the declared outcome expectations, and the guidance byte-budget ledger; customers never need to run them |
