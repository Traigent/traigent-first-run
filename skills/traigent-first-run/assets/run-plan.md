...
- Calibration cases and results artifacts, the reply-transform and task kind passed to them, and any `sent`/`delivered` pair a seam probe reported damaged or refused:
