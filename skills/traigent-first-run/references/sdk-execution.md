...
5 medium, 5 hard, and 5 very hard, plus the ten held-out rows reserved at creation time in their
own file, which no search ever evaluates. The enhanced space keeps the identical model list and expands beyond
