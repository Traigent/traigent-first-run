...
326_112 measured with `assistant_facing_documents()` after detaching this SDK
change from the owner-blocked Apache relicensing. The resident figure stays far
under its own ceiling, so this entry does not restate it.
