...
class RowIdsHaveAFallbackWhenTheDatasetHasNoneTests(unittest.TestCase):
    ...
    # digest and the ledger total noticed, and both are regenerated by any edit,
    # so a future change dropping the scope and dutifully relocking would go
    # green. The scheme was pinned and the condition that makes it true was not.
