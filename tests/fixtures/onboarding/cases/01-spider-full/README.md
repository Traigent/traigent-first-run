# Case 01 - SPIDER text2SQL (control)
...
- Task type: sql
- Dataset: 300 rows, labeled (has expected outputs), provenance=real
- Evaluator: set
- Agent knobs: 6 (model, temperature, prompt_style, output_format, fewshot_k, retrieval)
- Component states (agent/dataset/evaluation): {'agent': 'real', 'dataset': 'real', 'evaluation': 'real'}

## What the onboarding SHOULD conclude
- Readiness band: Excellent
- Caps triggered: none
- Recommended action: Proceed straight to optimization.
