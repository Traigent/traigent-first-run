# Case 04 - SPIDER text2SQL (no eval)
...
- Component states (agent/dataset/evaluation): {'agent': 'real', 'dataset': 'real', 'evaluation': 'missing'}

## What the onboarding SHOULD conclude
- Readiness band: Partial
- Caps triggered: no-eval (40)
- Recommended action: Build execution/set-match evaluator from the schema.
