# Case 10 - HotpotQA multi-hop (wrong ruler)
...
- Task type: qa_long
- Dataset: 50 rows, labeled (has expected outputs), provenance=real
- Evaluator: exact_on_freetext
- Agent knobs: 3 (model, temperature, retrieval)
- Component states (agent/dataset/evaluation): {'agent': 'real', 'dataset': 'real', 'evaluation': 'limited'}

## What the onboarding SHOULD conclude
- Readiness band: Partial
- Caps triggered: evaluator task-fit fail
- Recommended action: Swap exact match for a calibrated judge.
